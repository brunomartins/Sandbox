...
namespace GhTools.Attributes
{
    internal static class AttributeColors
    {
        ...
        internal static GH_PaletteStyle MMColorStyle => new GH_PaletteStyle(Color.FromArgb((int)byte.MaxValue, 231, 47, 135), Color.FromArgb((int)byte.MaxValue, 38, 183, 188), Color.Black);
    }
}