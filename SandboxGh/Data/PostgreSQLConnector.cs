...
namespace SandboxGh.Data
{
    public class PostgreSQLConnector : SandboxComponent
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Port", "P", "The port to connect to. The default port is 5432 for Azure PostgreSQLConnection.", GH_ParamAccess.item, "5432");
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Connection String", "CS", "Provides the connection string for further operations.", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var serverResults = SQLHelper.PostgreSQLConnection(server, port, uid, pw, db);

            DA.SetData(0, serverResults.Item1);
            DA.SetData(1, serverResults.Item2);
        }
